...
public class MyBean implements BeanNameAware,ApplicationContextAware,InitializingBean,DisposableBean{
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		System.out.println("ApplicationContextAware.setApplicationContext() 角青");
	}
	@Override
	...
	public void preDestory(){
		System.out.println("@PreDestory() 角青");
	}
	@Override
	public void destroy() throws Exception {
		System.out.println("DisposableBean.destory() 角青");
	}
	public void customDestory(){
		System.out.println("MyBean.customDestory() 角青");
	}
